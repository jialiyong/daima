...
<script type="text/javascript">
    ...
    var player = new TcPlayer('player', {
        "m3u8": " http://2444.liveplay.myqcloud.com/2444_<?= $courseid; ?>.m3u8",
        "flv": " http://2444.liveplay.myqcloud.com/live/2444_<?= $courseid; ?>.flv", //增加了一个flv的播放地址，用于PC平台的播放
    ...
    xhr.open('get', './countapi.php?courseid=<?= $courseid;?>&platform=腾讯&ip=<?= $ip; ?>&username=' + userName, 'true');
    xhr.send(null);
